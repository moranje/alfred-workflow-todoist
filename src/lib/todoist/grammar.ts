...
declare let pound: any;
declare let name: any;
declare let open: any;
declare let close: any;
declare let at: any;
declare let priority: any;
declare let doubleExclamation: any;
...
export const ParserRules: NearleyRule[] = [
...
export const ParserStart = 'Query';
